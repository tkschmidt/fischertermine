...
# Aggregate by location, region, and scrape date
dt_agg <- dt[, .(
...
#| fig-cap: "Free exam spots over time by location, split by region"
#| fig-height: 12
...
# Save plot
ggsave("plots/free_spots_by_location.png", p1, width = 16, height = 14, dpi = 300, bg = "white")
```
...
```{r plot-top10}
#| fig-cap: "Top 10 locations with most available spots, split by region"
#| fig-height: 12
...
p2 <- ggplot(dt_top, aes(x = scrape_date, y = total_free_spots, color = location, group = location)) +
  ...
  labs(
    ...
    subtitle = "Locations with highest average free spots, grouped by region",
    x = "Date",
    y = "Number of Free Spots",
    color = "Location"
  ) +
...
# Save plot
ggsave("plots/free_spots_top10_locations.png", p2, width = 16, height = 14, dpi = 300, bg = "white")
```
